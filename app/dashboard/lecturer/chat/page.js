        ...
        <div className="space-y-6 select-none font-sans">
            ...
            <div className="bg-white dark:bg-slate-900/50 p-6 rounded-2xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] border border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl flex items-center justify-center text-indigo-600 dark:text-indigo-400 shadow-sm border border-indigo-100/50 dark:border-indigo-900/50">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-slate-800 dark:text-slate-200 tracking-tight">Semester Chats</h1>
                        <p className="text-slate-500 dark:text-slate-400 font-medium mt-0.5 text-sm">Select semester to access student chats</p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                {semesters.map((term) => (
                    <Link href={`/dashboard/chat/y${term.year}s${term.semester}`} key={`y${term.year}s${term.semester}`} className="group block h-full">
                        <div className="bg-white dark:bg-slate-900/50 p-5 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700/80 hover:shadow-md hover:border-indigo-300 dark:hover:border-indigo-700/50 transition-all duration-300 h-full flex flex-col items-center text-center relative overflow-hidden">
                            ...
                            <div className="w-14 h-14 bg-white dark:bg-slate-900/50 shadow-sm border border-indigo-100 dark:border-indigo-900/50 text-indigo-600 dark:text-indigo-400 rounded-2xl flex flex-col items-center justify-center mb-4 group-hover:-translate-y-1 transition-transform duration-300 relative z-10">
                            ...
                            <h3 className="text-[17px] font-extrabold text-slate-800 dark:text-slate-200 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors relative z-10">
                            ...
                            <div className="mt-5 pt-4 border-t border-slate-100 dark:border-slate-800 w-full flex items-center justify-center text-indigo-600 dark:text-indigo-400 font-semibold text-[13px] gap-2 group-hover:gap-3 transition-all relative z-10 uppercase tracking-wide">
                                Open Chat
            ...
            {/* Info Footer */}
            <div className="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-900/50 rounded-xl p-4 flex items-start gap-3 mt-8">
                ...
                <div>
                    ...
                    <p className="text-indigo-700/80 dark:text-indigo-300 text-[13px] mt-1 font-medium leading-relaxed">
